                    ...
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            ...
                            <div class="col-auto d-flex w-sm-100">
                                <a href="{{route('admin.product-create')}}" class="btn btn-primary btn-set-task w-sm-100"><i class="icofont-plus-circle me-2 fs-6"></i>Add Products</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                            ...
                            <div class="card-body">
                                <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#">
                                                <img class="avatar rounded" src="{{$p->proImg}}" alt="">
                                                <span class="fw-bold ms-1">{{$p->name}}</span>
                                            </a>
                                        </td>
                                        <td>
                                            {{$p->discount}}
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                <a href="{{route('admin.product-edit', $p->slug)}}" class="btn btn-outline-secondary"><i class="icofont-edit text-success"></i></a>
